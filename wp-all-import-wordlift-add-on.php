<?php
/**
 * Plugin Name:         WP All Import - WordLift Add-On
 ...
 * Text Domain:         wp-all-import-wordlift-add-on
...
function __wpai_wl_addon__plugins_loaded() {
	...
	$addon->add_field(
		'entity__rel_uri',
		__( 'Relative Item Id', 'wp-all-import-wordlift-add-on' ),
		'text',
		null,
		__( 'The Item Id relative to the dataset URI, e.g. articles/headline_1.', 'wp-all-import-wordlift-add-on' ),
		false
	);
...
function __wpai_wl_addon__notice() {
	add_action( 'admin_notices', function () {
        ...
        <div class="notice notice-error is-dismissible">
            <p><?php _e( 'WP All Import - WordLift Add-On requires WordLift to be installed and activate, please check the plugins page.', 'wp-all-import-wordlift-add-on' ); ?></p>
        </div>
		<?php
	} );
}
